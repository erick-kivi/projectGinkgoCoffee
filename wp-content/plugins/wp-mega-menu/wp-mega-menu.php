...
/*
  ...
  Plugin URI:  https://accesspressthemes.com/wordpress-plugins/wp-mega-menu/
...
defined( 'APMM_VERSION' ) or define( 'APMM_VERSION', '1.0.9' ); //plugin version
defined( 'APMM_TITLE' ) or define( 'APMM_TITLE', 'WP MEGA MENU' ); //plugin version
defined( 'APMM_TD' ) or define( 'APMM_TD', 'wp-mega-menu' ); //plugin's text domain
        ...
        if ( is_multisite() ) {
             include_once( ABSPATH . 'wp-admin/includes/plugin.php' );
                if (is_plugin_active('wp-mega-menu-pro/wp-mega-menu-pro.php')) {
                 wp_die( __( 'You need to deactivate WP Mega Menu Pro Plugin in order to activate WP Mega Menu Free plugin.Please deactivate premium one.', APMM_PRO_TD ) );
