   ...
   <h3><?php _e('How to Use',APMM_TD);?></h3>
      <p>       
       ...
       _e(' In order to display the mega menu in the frontend for specific menu location, you need to build the menu location first.
        To build menu location and enable WP Mega Menu settings for specific location, you have to setup options provided on WordPress menu page.',APMM_TD);?>
      </p>
     ...
     <p><?php _e('For full documentation on the plugin, please visit ',APMM_TD);?><a href="https://accesspressthemes.com/documentation/wp-mega-menu/" target="_blank"><?php _e('View Documentation',APMM_TD);?></a></p>

      <h4><?php _e('Menu Settings');?></h4>
       <p>       
       <?php 
       _e('To enable WP Mega Menu for specific menu location, on menu page, you can choose menu location and on left section you can find options settings as Select WP Mega Menu Settings Metabox Options where you
       ...
       <p><?php _e('To setup mega menu or flyout type for particular menu. On hover menu you can find WP Mega Menu Button where you can setup options menu wise. In these options, you can set mega menu type sub menu for top level menu only.',APMM_TD);?></p>
      ...
      <dl>
       ...
       <p><?php _e('This level menu includes following tab options:',APMM_TD);?></p>
        <ul>
          <li><strong><?php _e('* WP Mega Menu Settings',APMM_TD);?></strong>
               <ul><li>
      ...
      <h4><?php _e('Widgets Information');?></h4>
       <p>       
       <?php 
       _e('To display WP Mega Menu of specific menu location, WP Mega Menu has provided WP Mega Menu Widget on widget page where you can
        ...
        any other page or default Text Widget.',APMM_TD);?><br/>
           <?php _e('WP Mega Menu Plugin has also provided its own WP Mega Menu Contact Info widgets where you can setup your contact details with multiple font awesome icon class and any shortcode to display on mega menu.',APMM_TD);?>
        </p>
