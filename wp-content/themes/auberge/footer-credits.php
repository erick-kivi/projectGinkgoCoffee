	...
	<div class="site-info-container">
		...
		<div class="site-info" role="contentinfo">
			<?php if ( empty( $custom_credits ) ) : ?>
				...
				printf(
					esc_html_x( 'Also check out: %s', '%s: WordPress, linked to a website.', 'auberge' ),
					'<a href="' . esc_url( __( 'http://dev-teamerickcoffeehouse.pantheonsite.io/fair-trade-and-organic-products/', 'auberge' ) ) . '">Fair Trade and Organic Products</a>'
				);
