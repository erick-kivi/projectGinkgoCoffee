      ...
      */
                ...
                if(isset($_POST['settings_submit'])){
                  include_once(APMM_PATH.'/inc/backend/save_settings.php');
                      ...
                      if ( $custom_theme_id != '' ) {
                         ...
                         wp_redirect( admin_url( 'admin.php?page=wp-mega-menu' ) );
                         exit;
                      } 
       ...
       */
       function apmegamenu_admin_scripts( $hook ){
            $plugin_pages = array( APMM_TD,'wpmm-theme-settings','wpmm-how-to-use','wpmm-add-theme','wpmm-edit-theme','wpmm-about-us','wp-mega-menu');
     ...
     */
       ...
       // echo "hook".$hook;
          ...
          $apmm_variable = array(
                    ...
                    'menu_lightbox' => __("WP Mega Menu", APMM_TD),
                    'ajax_url' => admin_url() . 'admin-ajax.php',
                    'checked_disabled_error' => __("Please enable WP Mega Menu using the WP Mega Menu Settings on left section of this page.", APMM_TD),
       ...
       */
		  function addAPMegamenuMetaBox() {
            if (wp_get_nav_menus()) {
                add_meta_box('nav-menu-theme-apmegamenus', __('Select WP Mega Menu Settings', APMM_TD), array($this, 'createAPMegamenuMetaBox'), 'nav-menus', 'side', 'high');
            }
        }
       ...
       */
        ...
        function apmm_megamenu_options($menuid){
           ...
           if(!count($menu_theme_locations)){
            ...
            echo "<p>" . __("You will need to create a new menu location to enable WP Mega Menu.", APMM_TD) . "</p>";

           } else if ( ! count ( $tagged_menu_locations ) ) {

              echo "<p>" . __("This Menu is not assigned to any theme location yet. <br/>To Enable WP Mega Menu, First please assign this menu to theme location.", APMM_TD) . "</p>";
